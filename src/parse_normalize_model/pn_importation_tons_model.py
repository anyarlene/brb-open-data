...
class ImportationTonsParseNormalizeModel:
    def __init__(self):
        # Define paths and attributes here
    ...
    def load_data(self):
        ...
        target_files = [file for file in os.listdir(self.input_folder) if file.startswith("processed") and file.endswith("_tons.csv")]
    ...
    def process_data(self, df_original):
        ...
        # Initialization for current continent, subregion, total, and subtotal values
        ...
        # Drop rows that are headers or TOTAL rows
