...
RELATIVE_PATH_IMPORTATION_TONS = config("RELATIVE_PATH_IMPORTATION_TONS")
full_url = BASE_URL + RELATIVE_PATH_IMPORTATION_TONS
...
excel_filename = os.path.basename(RELATIVE_PATH_IMPORTATION_TONS).replace('%', '_')
...
csv_path = os.path.join(cleaned_folder, 'processed_importation_tons.csv')
